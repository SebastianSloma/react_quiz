...
export const CategoryPage = () => {
	...
	return (
		...
		<div
			className='container my-8 flex flex-col  items-center justify-center gap-10'
			>
			{activeQuiz ? (
				<Question
				...
				<>
					...
					<button
						className='mb-10 border border-zinc-300 text-gray-500 bg-white px-5 py-2 rounded-lg shadow-xl hover:shadow-inner transition-all font-bold  hover:text-gray-600'
